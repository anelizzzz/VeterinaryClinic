  ...
  <nav class="navbar">
    <div class="container nav-content">
      <div class="brand-group">
        <router-link to="/" class="brand">
          <span class="brand-icon">
            <svg viewBox="0 0 64 64" aria-hidden="true">
              ircle cx="20" cy="18" r="6" />
              ircle cx="42" cy="18" r="6" />
              ircle cx="14" cy="34" r="5" />
              ircle cx="48" cy="34" r="5" />
        ...
        <router-link to="/adoptii" class="adopt-btn">
          Adoptă un animal!
        </router-link>
      </div>
          ...
          <div class="account-box">
            <div class="account-dropdown" ref="dropdownRef">
              ...
              >
                ...
                <span
                  class="account-name profile-tooltip"
                  data-tooltip="Editează profilul"
                >
...
.brand-icon {
  ...
  place-items: center;
  border-radius: 16px;
  background: linear-gradient(135deg, #ffe0eb 0%, #ffd1e2 100%);
...
.account-trigger:hover .profile-tooltip::after {
  opacity: 1;
  visibility: visible;
